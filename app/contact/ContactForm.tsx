  ...
  if (status === 'success') {
    return (
      <div style={{ background: '#fff', borderRadius: 16, padding: '32px 24px', textAlign: 'center', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
        ...
        <a href={`https://wa.me/918328443057?text=${encodeURIComponent('Hi Agastya, I just booked a call on your website!')}`}
  ...
  return (
    <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      <p style={{ textAlign: 'center', fontSize: 11, color: '#9CA3AF', margin: 0 }}>
        ...
        <a href="tel:+918328443057" style={{ color: '#E86C2F' }}>Or call us directly</a>
      </p>

      {status === 'error' && (
        <p style={{ background: '#FEF2F2', borderRadius: 8, padding: '12px', fontSize: 13, color: '#DC2626' }}>
          Something went wrong. WhatsApp us at <a href="https://wa.me/918328443057" style={{ fontWeight: 700 }}>+91 83284 43057</a>
        </p>
      )}
    </form>
  );
